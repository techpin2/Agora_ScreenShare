...
namespace Agora.Rtc
{
    ...
    public abstract class IRtcEngine
    {
        ...
        /// </summary>
        ///
        /// <param name="sync"> Whether the method is called synchronously: true : Synchronous call. false : Asynchronous call. Currently this method only supports synchronous calls. Do not set this parameter to this value.</param>
        ///
        ...
        /// The remote client: OnUserJoined, if the user joining the channel is in the Communication profile or is a host in the Live-broadcasting profile. This method enables users to join a channel. Users in the same channel can talk to each other, and multiple users in the same channel can start a group chat. Users with different App IDs cannot call each other. Once a user joins the channel, the user subscribes to the audio and video streams of all the other users in the channel by default, giving rise to usage and billing calculation. To stop subscribing to a specified stream or all remote streams, call the corresponding mute methods.
        /// </summary>
        ///
        ...
        /// <param name="uid"> The user ID. This parameter is used to identify the user in the channel for real-time audio and video interaction. You need to set and manage user IDs yourself, and ensure that each user ID in the same channel is unique. This parameter is a 32-bit unsigned integer. The value range is 1 to 2 32 -1. If the user ID is not assigned (or set to 0), the SDK assigns a random user ID and returns it in the OnJoinChannelSuccess callback. Your application must record and maintain the returned user ID, because the SDK does not do so.</param>
        ///
        /// <param name="token"> The token generated on your server for authentication. When the token for preloading channels expires, you can update the token based on the number of channels you preload.
        ...
        ///  If you use different tokens to preload different channels, call this method to pass in your user ID, channel name and the new token.</param>
        ///
        ...
        /// Call EnableVideo to enable the video module.
        /// The local preview enables the mirror mode by default.
        /// After the local video preview is enabled, if you call LeaveChannel [2/2] to exit the channel, the local preview remains until you call StopPreview [2/2] to disable it.
        ...
        /// </summary>
        ///
        /// <param name="scenarioType"> The type of video application scenario. See VIDEO_APPLICATION_SCENARIO_TYPE. If set to APPLICATION_SCENARIO_MEETING (1), the SDK automatically enables the following strategies:
        ...
        ///  Android: /storage/emulated/0/Android/data/<package name>/files/example.jpg Ensure that the path you specify exists and is writable.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// Call this method with enabled set to false. You can call this method before and after StartPreview [1/2] to enable multi-camera capture:
        ...
        /// </summary>
        ///
        /// <param name="sourceType"> The type of the video source. See VIDEO_SOURCE_TYPE.
        ...
        ///  On the desktop platforms, you can capture video from up to 4 cameras.</param>
        ///
        ...
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure. ERR_NOT_SUPPORTED (4): The current device version is below Android 5.0, and this operation is not supported.
        /// </returns>
        ///
        ...
        ///
        /// <param name="type"> The type of the video source. See MEDIA_SOURCE_TYPE. In this method, this parameter supports only the following two settings:
        ///  The default value is PRIMARY_CAMERA_SOURCE.
        ///  If you want to use the second camera to capture video, set this parameter to SECONDARY_CAMERA_SOURCE.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        ///
        /// <param name="cycle"> The number of times the music file plays.
        ...
        ///  -1: Play the audio file in an infinite loop.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        ///
        /// <param name="loopCount"> The number of times the audio effect loops.
        ...
        ///
        /// <param name="pan"> The spatial position of the audio effect. The value ranges between -1.0 and 1.0:
        ///  -1.0: The audio effect is heard on the left of the user.
        ///  0.0: The audio effect is heard in front of the user.
        ///  1.0: The audio effect is heard on the right of the user.</param>
        ///
        ...
        ///  1: Play the audio effect twice.</param>
        ///
        ...
        ///  1.0: The audio effect shows on the right.</param>
        ///
        ...
        /// Call this method to set a preset voice beautifier effect for the local user who sends an audio stream. After setting a voice beautifier effect, all users in the channel can hear the effect. You can set different voice beautifier effects for different scenarios. For better voice effects, Agora recommends that you call SetAudioProfile [1/2] and set scenario to AUDIO_SCENARIO_GAME_STREAMING (3) and profile to AUDIO_PROFILE_MUSIC_HIGH_QUALITY (4) or AUDIO_PROFILE_MUSIC_HIGH_QUALITY_STEREO (5) before calling this method.
        /// You can call this method either before or after joining a channel.
        /// Do not set the profile parameter in SetAudioProfile [1/2] to AUDIO_PROFILE_SPEECH_STANDARD (1)
        ...
        /// </summary>
        ///
        /// <param name="preset"> The options for SDK preset audio effects: ROOM_ACOUSTICS_3D_VOICE, 3D voice effect:
        ...
        ///
        /// <param name="param1"> If you set preset to ROOM_ACOUSTICS_3D_VOICE, param1 sets the cycle period of the 3D voice effect. The value range is [1,60] and the unit is seconds. The default value is 10, indicating that the voice moves around you every 10 seconds.
        ///  If you set preset to PITCH_CORRECTION, param1 indicates the basic mode of the pitch correction effect: 1 : (Default) Natural major scale. 2 : Natural minor scale. 3 : Japanese pentatonic scale.</param>
        ///
        /// <param name="param2"> If you set preset to ROOM_ACOUSTICS_3D_VOICE , you need to set param2 to 0.
        ///  If you set preset to PITCH_CORRECTION, param2 indicates the tonic pitch of the pitch correction effect: 1 : A 2 : A# 3 : B 4 : (Default) C 5 : C# 6 : D 7 : D# 8 : E 9 : F 10 : F# 11 : G 12 : G#</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// The difference and connection between this method and EnableDualStreamMode [1/2] is as follows:
        /// When calling this method and setting mode to DISABLE_SIMULCAST_STREAM, it has the same effect as EnableDualStreamMode [1/2] (false).
        /// When calling this method and setting mode to ENABLE_SIMULCAST_STREAM, it has the same effect as EnableDualStreamMode [1/2] (true).
        ...
        /// Use AddVideoWatermark [2/2] instead. This method adds a PNG watermark image to the local video stream in a live streaming session. Once the watermark image is added, all the users in the channel (CDN audience included) and the video capturing device can see and capture it. If you only want to add a watermark to the CDN live streaming, see descriptions in.
        ...
        /// If you have enabled the local video preview by calling the StartPreview [1/2] visibleInPreview member to set whether or not the watermark is visible in the preview.
        ...
        /// </summary>
        ///
        /// <param name="encryptionMode"> The following encryption modes:
        ...
        ///  "": When this parameter is set as null, the encryption mode is set as " aes-128-gcm " by default.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="config"> Configuration of the local video mixing, see LocalTranscoderConfiguration.
        ...
        ///  The maximum resolution of the mixed video stream is 4096 × 2160.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        ///
        /// <param name="channels"> The number of audio channels of the external audio sink:
        ///  1: Mono.
        ///  2: Stereo.</param>
        ///
        /// <returns>
        ...
        ///
        /// <param name="channel"> The number of channels returned in the OnRecordAudioFrame callback:
        ///  1: Mono.
        ///  2: Stereo.</param>
        ///
        ...
        ///
        /// <param name="channel"> The number of channels returned in the OnPlaybackAudioFrame callback:
        ///  1: Mono.
        ///  2: Stereo.</param>
        ///
        /// <param name="mode"> The use mode of the audio frame. See RAW_AUDIO_FRAME_OP_MODE_TYPE.</param>
        ...
        ///
        /// <param name="channel"> The number of audio channels reported in the OnEarMonitoringAudioFrame callback.
        ///  1: Mono.
        ///  2: Stereo.</param>
        ///
        /// <param name="mode"> The use mode of the audio frame. See RAW_AUDIO_FRAME_OP_MODE_TYPE.</param>
        ...
        /// </summary>
        ///
        /// <param name="type"> Type of media source. See MEDIA_SOURCE_TYPE. In this method, this parameter supports only the following two settings:
        ...
        /// This method should be called after the JoinChannel [2/2] method. The recording automatically stops when you call the LeaveChannel [1/2]
        ...
        /// <param name="filePath"> The absolute path (including the filename extensions) of the recording file. For example: C:\music\audio.mp4. Ensure that the directory for the log files exists and is writable.</param>
        ///
        /// <param name="sampleRate"> The sample rate (kHz) of the recording file. Supported values are as follows:
        ///  16000
        ///  (Default) 32000
        ///  44100
        ///  48000</param>
        ...
        /// This method is for Android and iOS only.
        /// This method must be called after the camera is turned on, such as calling after StartPreview [2/2] and EnableVideo.
        /// </summary>
        ///
        ...
        /// </summary>
        ///
        /// <param name="route"> The audio playback route you want to use:
        ...
        /// </summary>
        ///
        /// <param name="interval"> Sets the time interval between two consecutive volume indications:
        ///  ≤ 0: Disables the volume indication.
        ///  > 0: Time interval (ms) between two consecutive volume indications. The lowest value is 50.</param>
        ///
        ...
        /// </summary>
        ///
        /// <param name="codecInfo"> Input and output parameter. An array representing the video codec capabilities of the device. See CodecCapInfo.
        ...
        ///
        /// <param name="size"> Input and output parameter, represent the size of the CodecCapInfo array.
        ///  Input value: Size of the CodecCapInfo defined by the user when executing the method.
        ///  Output value: Size of the output CodecCapInfo after this method is executed.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// <param name="uid"> The user ID of the remote user.</param>
        ///
        /// <param name="pan"> The voice position of the remote user. The value ranges from -1.0 to 1.0:
        ///  0.0: (Default) The remote voice comes from the front.
        ///  -1.0: The remote voice comes from the left.
        ///  1.0: The remote voice comes from the right.</param>
        ///
    ...
    public abstract class IRtcEngineEx : IRtcEngine
    {
        ...
        /// If you call Dispose immediately after calling this method, the SDK does not trigger the OnLeaveChannel callback.
        /// Calling LeaveChannel [1/2] will leave the channels when calling JoinChannel [2/2] and JoinChannelEx at the same time.
        /// </summary>
        ///
        /// <param name="connection"> The connection information. See RtcConnection.</param>
        ///
        ...
        /// This method lets the user leave the channel, for example, by hanging up or exiting the call. After calling JoinChannelEx to join the channel, this method must be called to end the call before starting the next call. This method can be called whether or not a call is currently in progress. This method releases all resources related to the session. This method call is asynchronous. When this method returns, it does not necessarily mean that the user has left the channel. After you leave the channel, the SDK triggers the OnLeaveChannel callback. After actually leaving the channel, the local user triggers the OnLeaveChannel callback; after the user in the communication scenario and the host in the live streaming scenario leave the channel, the remote user triggers the OnUserOffline callback.
        /// If you call Dispose immediately after calling this method, the SDK does not trigger the OnLeaveChannel callback.
        /// Calling LeaveChannel [2/2] will leave the channels when calling JoinChannel [2/2] and JoinChannelEx at the same time.
        /// </summary>
        ///
        /// <param name="connection"> The connection information. See RtcConnection.</param>
        ///
        ...
        /// <summary>
        /// Sets the dual-stream mode on the sender side.
        /// The SDK enables the low-quality video stream auto mode on the sender by default, which is equivalent to calling this method and setting the mode to AUTO_SIMULCAST_STREAM. If you want to modify this behavior, you can call this method and modify the mode to DISABLE_SIMULCAST_STREAM (never send low-quality video streams) or ENABLE_SIMULCAST_STREAM (always send low-quality video streams). The difference and connection between this method and EnableDualStreamModeEx is as follows:
